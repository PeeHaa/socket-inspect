...
class ClientSentTest extends TestCase
{
    ...
    {
        $this->message = new ClientSent(new Address('tcp://127.0.0.1:1337'), 'the message', 'tcp://127.0.0.1:50234');
    }
    ...
    {
        $this->assertTrue($this->message->getInitiator()->equals(Initiator::CLIENT()));
    }
