...
class ConnectedToServerTest extends TestCase
{
    ...
    {
        $this->message = new ConnectedToServer(
    ...
    {
        $this->assertSame(
            'Connected to server `tcp://8.8.8.8:53` on behalf of client `tcp://127.0.0.1:50234`',
