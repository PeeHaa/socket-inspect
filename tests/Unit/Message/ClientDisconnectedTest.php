...
class ClientDisconnectedTest extends TestCase
{
    ...
    {
        $this->message = new ClientDisconnected(new Address('tcp://127.0.0.1:1337'), 'tcp://127.0.0.1:50234');
    }
    ...
    {
        $this->assertSame('Client (tcp://127.0.0.1:50234) disconnected', $this->message->getMessage());
    }
}
